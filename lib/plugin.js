...
module.exports = function (source, path) {
  let result
  try {
    // Paths generated by webpack source maps can have a query string (like '?ab01)
    const hasJsxExtensionAndOptionalQueryString = /[.][jt]sx([?][abcdef0-9]+)?$/;
    const loader = path.match(hasJsxExtensionAndOptionalQueryString) ? { loader: 'tsx', jsx: 'preserve' } : {}
